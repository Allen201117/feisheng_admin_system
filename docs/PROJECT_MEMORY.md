...
- `pages/boss/leave-records/leave-records`：请假提醒列表（谁/哪几天/原因），打开即清未读红点；页头「代员工请假」可代不会自助操作的员工补录请假（选员工+月份+日历多选，允许选已过去日期），代录记录标「老板代录」。
